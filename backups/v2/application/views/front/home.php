    ...
    <div class="row">
      <div class="col-md-5 offset-1">
        ...
        <h3>We Help Retailers
          Achieve  Gameplan.</h3>
        <div class="img-box"> <img src="<?php echo base_url();?>assets/front/images/store.jpg" class="img-fluid" />
          <div class="text_details"><span><a href="#"><img src="<?php echo base_url();?>assets/front/images/arrow.png"/></a></span>
            <div class="clearfix"></div>
            <h4> Store Payroll Control 
              and Tracking </h4>
          </div>
        </div>
        <div class="blue-box"> <span><a href="#"><img src="<?php echo base_url();?>assets/front/images/arrow.png"/></a></span>
          <h2>PAYMENT
            PROCESSING</h2>
          <p>Implementing Square 
            Terminal with Legacy 
            POS system </p>
        </div>
      </div>
      <div class="col-md-5 offset-1">
        <div class="img-box"> <img src="<?php echo base_url();?>assets/front/images/foot.jpg" class="img-fluid" />
          <div class="text_details"><span><a href="#"><img src="<?php echo base_url();?>assets/front/images/arrow.png"/></a></span>
            <div class="clearfix"></div>
            <h4> Revenue per 
              Customer Footwear</h4>
          </div>
        </div>
        <br/>
        <br/>
        <br/>
        <div class="img-box"> <img src="<?php echo base_url();?>assets/front/images/merchant.jpg" class="img-fluid" />
          <div class="text_details"><span><a href="#"><img src="<?php echo base_url();?>assets/front/images/arrow.png"/></a></span>
            <div class="clearfix"></div>
            <h4> Store Merchandising
              Forecast </h4>
          </div>
        </div>
        <div class="img"> <a href="#"> More Solutions <i class="fa fa-arrow-circle-right" aria-hidden="true"></i> </a> </div>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="col-md-4 jasgrid">
        <div class="box-item">
          <div class="box-post"> <span class="label label-success"> <a href="#" rel="tag">Retail</a> </span>
            <h3 class="post-title"> <a href="#"> End to one-day black Friday shopping deals? </a> </h3>
            <span class="meta"> <span><i class="glyphicon glyphicon-comment"></i> <a href="#">No Comments</a></span> <span><i class="glyphicon glyphicon-time"></i> Oct 28, 2020</span> </span> </div>
          <img src="<?php echo base_url();?>assets/front/images/blog1.jpg" alt="" 
                class="img-fluid"> </div>
      </div>
      <div class="col-md-4 jasgrid">
        <div class="box-item">
