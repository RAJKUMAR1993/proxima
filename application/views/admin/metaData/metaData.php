...
<?php
	...
	$p = $this->db->get_where("tbl_pages",array("deleted"=>0,"id"=>$id))->row();
...
<?php admin_sidebar() ?> 
        	<div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Meta Data</h3>
...
-->
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() ?>admin/Metadata/updateMeta">
                                <div class="card-body">
                                                ...
                                                <div class="input-group">
                                                   <select class="form-control" id="status" name="pid" required>
                                                       <?php
															...
															$pages = $this->db->get_where("tbl_pages",array("status"=>"Active","deleted"=>0))->result();
                             ...
                             <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table product-overview table-striped" id="mainmenu">
                                        ...
                                        <?php 
                                        $i = 0;
										$opt = $this->db->query("select * from tbl_pages where deleted=0 order by id asc")->result();       	
                                           foreach ($opt as $u) {  
										?> 
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;"><a href="<?php echo base_url() ?>admin/metadata/index/<?php echo $u->id ?>"><button type="button" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></button></a></td>    
                                            </tr>
                                        <?php } ?> 
