...
<!--                            <a href="<? //echo base_url('admin/settings') ?>" class="dropdown-item"><i class="ti-settings"></i> Settings</a>-->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       ...
                       <!-- <li class="sidebar-item <? echo ($uri == "menus") ? 'active' : ''; ?>"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url(); ?>admin/menus/arrange_menus" aria-expanded="false"><i class="mdi mdi-gauge"></i>
